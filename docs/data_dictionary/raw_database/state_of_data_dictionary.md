# Dicionário de Dados-State of Data Brazil 2023
---
...
|Atributo	|Tipo de dado	|Descrição|
| -------------  | ------------- |------------------------------------------------------------       |
|P3_a	|Qualitativo ordinal|	Qual o número aproximado de pessoas que atuam com dados na sua empresa hoje?|
|P3_b	|Qualitativo não ordinal|	Quais esses papéis/cargas fazem parte do tempo (ou capítulo) de dados da sua empresa?|
|P3_b_1	|Qualitativo binário|	Engenheiro de Análise.|
|P3_b_2	|Qualitativo binário|	Engenharia de Dados/Engenheiro de Dados.|
|P3_b_3	|Qualitativo binário|	Analista de Dados/Analista de Dados.|
|P3_b_4	|Qualitativo binário|	Cientista de Dados/Cientista de Dados.|
|P3_b_5	|Qualitativo binário|	Administrador de banco de dados/DBA.|
|P3_b_6	|Qualitativo binário|	Analista de Business Intelligence/BI.|
|P3_b_7	|Qualitativo binário|	Arquiteto de Dados/Data Architect.|
|P3_b_8	|Qualitativo binário|	Gerente de Produto de Dados/DPM.|
|P3_b_9	|Qualitativo binário|	Analista de Negócios.|
|P3_c	|Qualitativo não ordinal|	Quais essas responsabilidades fazem parte da sua rotina atual de trabalho como gestor?|
|P3_c_1	|Qualitativo binário|	Pensar na visão de longo prazo de dados da empresa e fortalecimento da cultura analítica da companhia.|
|P3_c_2	|Qualitativo binário|	Organização de treinamentos e iniciativas com o objetivo de aumentar a maturidade analítica das áreas de negócios.|
|P3_c_3	|Qualitativo binário|	Atração, seleção e contratação de talentos para o tempo de dados.|
|P3_c_4	|Qualitativo binário|	Decisão sobre contratação de ferramentas e tecnologias relacionadas a dados.|
|P3_c_5	|Qualitativo binário|	Sou gestor da equipe responsável pela engenharia de dados e por manter o Data Lake da empresa como fonte única dos dados, garantindo a qualidade e confiabilidade da informação.|
|P3_c_6	|Qualitativo binário|	Sou gestor da equipe responsável pela entrega de dados, estudos, relatórios e dashboards para as áreas de negócio da empresa.|
|P3_c_7	|Qualitativo binário|	Sou gestor da equipe responsável por iniciativas e projetos envolvidos Inteligência Artificial e Machine Learning.|
|P3_c_8	|Qualitativo binário|	Apesar de ser gestor ainda atuo na parte técnica, construindo soluções/análises/modelos etc.|
|P3_c_9	|Qualitativo binário|	Gestão de projetos de dados, cuidando das etapas, equipes envolvidas, atingimento dos objetivos etc.|
|P3_c_10	|Qualitativo binário|	Gestão de produtos de dados, cuidando da visão dos produtos, backlog, feedback de usuários etc.|
|P3_c_11	|Qualitativo binário|	Gestão de pessoas, apoio no desenvolvimento das pessoas, evolução de carreira.|
|P3_d	|Qualitativo não ordinal|	Quais são os 3 maiores desafios que você tem como gestor no momento atual?|
|P3_d_1	|Qualitativo binário|	a Contratar novos talentos.|
|P3_d_2	|Qualitativo binário|	b Reter talentos.|
|P3_d_3	|Qualitativo binário|	c Convencer a empresa a aumentar os investimentos na área de dados.|
|P3_d_4	|Qualitativo binário|	Gestão de equipes no ambiente remoto.|
|P3_d_5	|Qualitativo binário|	e Gestão de projetos envolvendo áreas multidisciplinares da empresa.|
|P3_d_6	|Qualitativo binário|	f Organizar as informações e garantir a qualidade e confiabilidade.|
|P3_d_7	|Qualitativo binário|	G Conseguir processar e armazenar um alto volume de dados.|
|P3_d_8	|Qualitativo binário|	h Conseguir gerar valor para as áreas de negócios através de estudos e experimentos.|
|P3_d_9	|Qualitativo binário|	Desenvolver e manter modelos de Machine Learning em produção.|
|P3_d_10	|Qualitativo binário|	j Gerenciar a expectativa das áreas de negócio em relação às entregas das equipes de dados.|
